-- Separate Arab nationality from country of residence.
-- Existing `region` remains the nationality/ranking field; existing `country` stores residence.
...
begin
  ...
  if v_nationality not in (
    'السعودية','الإمارات','الكويت','البحرين','قطر','عُمان','اليمن','العراق',
    'الأردن','فلسطين','لبنان','سوريا','مصر','السودان','ليبيا','تونس',
    'الجزائر','المغرب','موريتانيا','الصومال','جيبوتي','جزر القمر'
  ) then
    raise exception 'unsupported nationality';
  end if;
