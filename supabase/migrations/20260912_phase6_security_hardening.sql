...
revoke execute on function public.claim_player_profile(text,text,text,text,text) from anon;
grant execute on function public.claim_player_profile(text,text,text,text,text) to authenticated;

revoke execute on function public.claim_player_profile(text,text,text,text,text,text) from anon;
grant execute on function public.claim_player_profile(text,text,text,text,text,text) to authenticated;

revoke execute on function public.claim_player_profile_v2(text,text,text,text,text,text) from anon;
grant execute on function public.claim_player_profile_v2(text,text,text,text,text,text) to authenticated;

revoke execute on function public.get_my_player_profile() from anon;
grant execute on function public.get_my_player_profile() to authenticated;

revoke execute on function public.get_my_player_profile_v2() from anon;
grant execute on function public.get_my_player_profile_v2() to authenticated;

revoke execute on function public.poll_matchmaking() from anon;
grant execute on function public.poll_matchmaking() to authenticated;

revoke execute on function public.send_player_challenge(uuid,integer) from anon;
grant execute on function public.send_player_challenge(uuid,integer) to authenticated;

revoke execute on function public.set_my_gender_once(text) from anon;
grant execute on function public.set_my_gender_once(text) to authenticated;

revoke execute on function public.start_matchmaking(integer) from anon;
grant execute on function public.start_matchmaking(integer) to authenticated;

revoke execute on function public.start_matchmaking_v2(integer,text) from anon;
