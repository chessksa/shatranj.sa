...
assert.match(inlineCss,/\.inline-play-piece\[src\$=["']wp\.png["']\][\s\S]*?\.inline-play-piece\[src\$=["']bp\.png["']\][\s\S]*?transform:scale\(1\.12\)/,'يجب تكبير الجنود البيض والسود فقط بنسبة إضافية');
